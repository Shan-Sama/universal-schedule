...
export interface Meeting { id: string; componentType: string; group: string; day: number | null; slot: number | null; startPeriod: number | null; endPeriod: number | null; room: string; lecturer: string; lecturers: string[]; note: string; shift: string; weekExpression: string; weeks: number[] | null; occupiesSlot: boolean }
